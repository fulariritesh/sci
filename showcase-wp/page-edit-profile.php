			...
			<div class="photogrid">
				...
				<div class="row">
					...
					<div class="col-6 col-sm-6 pt-3 px-0 text-right">
						<a href="<?php echo get_page_by_title('Manage Photos')->guid; ?>" class="btn btn-edit" data-target="#managephotos">Edit</a>
						<a href="<?php echo get_page_by_title('Manage Photos')->guid; ?>" class="btn btn-add" data-target="#addphotos">Add</a>
					</div>
				</div>
...
<!--Intro Modal -->
<div class="modal fade" id="editIntro-m" tabindex="-1" aria-labelledby="editIntroModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-xl">
      <div class="modal-content">
        <div class="modal-header">
          <div class="col-md-3 d-none d-lg-block">
...
<div class="modal fade" id="bulkedit" tabindex="-1" aria-labelledby="bulkedit" aria-hidden="true">
  <div class="modal-dialog modal-md">
    <div class="modal-content">
      <div class="modal-header">
        <div class="col-3 d-none  d-lg-block">
      ...
      <div class="modal-body">
        <form action="">
          <div class="row">
              ...
              <div class="col-6 pt-4 mx-auto text-center viewphotodiv">
                <img src="/images/gridimg/1.jpg" />
              </div>
              <div class="col-6 pt-3 mx-auto px-0">
                <label class="col-12 pt-3">Add a caption</label>
                <div class="col-12">
