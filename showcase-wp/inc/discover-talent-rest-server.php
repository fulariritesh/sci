  ...
  public function get_talent_data( WP_REST_Request $request ){
    ...
    if( !empty( $userList ) ){
      ...
      foreach($userList as $user){
          ...
          $user->location = get_field('sci_user_location', 'user_' . $user->ID) != null && !empty(get_field('sci_user_location', 'user_' . $user->ID)) && !is_null(get_field('sci_user_location', 'user_' . $user->ID))?get_field('sci_user_location', 'user_' . $user->ID)['label']:"";  
